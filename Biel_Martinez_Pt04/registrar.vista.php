...
<form action="registrar.php" method="post">
    ...
    Repetir contrasenya: <input type="password" name="contrasenya2" value="<?php echo htmlspecialchars(isset($_POST['contrasenya2']) ? $_POST['contrasenya2'] : ''); ?>"> <?php echo isset($errors[2]) ? $errors[2] : ''; ?><br>
